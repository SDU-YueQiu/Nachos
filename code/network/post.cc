...
//      "orderability" is the probability that a network packet that
//        is delivered is delivered without delay (e.g., orderability = 1
//        means that delivered packets are never delayed)
...
void PostOffice::Send(PacketHeader pktHdr, MailHeader mailHdr, char *data)
{
...
void PostOffice::Receive(int box, PacketHeader *pktHdr,
